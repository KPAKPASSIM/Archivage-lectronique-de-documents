...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('document.update',$document->id) }}" autocomplete="off"
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('titre_document') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('titre_document') ? ' is-invalid' : '' }}"
                                                   name="titre_document" id="input-titre" type="text"
                                                   placeholder="{{ __('Titre') }}"
                                                   value="{{ old('titre_document', $document->titre_document) }}"
                                                   required="true" aria-required="true"/>
                                            @if ($errors->has('titre_document'))
                                                <span id="titre-error" class="error text-danger"
                                                      for="input-titre">{{ $errors->first('titre_document') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                                   name="nom_auteur" id="input-nom_auteur" type="text"
                                                   placeholder="{{ __('Nom') }}"
                                                   value="{{ old('nom_auteur', $document->nom_auteur) }}"
                                                   required="true" aria-required="true"/>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                                   ...
                                                   value="{{ old('adresse_auteur',$document->adresse_auteur) }}"
                                                   required="true" aria-required="true"/>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                                   ...
                                                   placeholder="{{ __('date archivage') }}"
                                                   value="{{ old('date_archivage', $document->date_archivage) }}"
                                                   required="true" aria-required="true"/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('type_document_id') ? ' has-danger' : '' }}">
                                            <select class="form-control" required id="typedoc" name="type_document_id">
                                                <option value="{{ old('type_document_id', $document->type_documents_id) }}"></option>
