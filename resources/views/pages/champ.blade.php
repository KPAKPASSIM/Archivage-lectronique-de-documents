                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title ">{{ __('Champs formulaires') }}</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12 text-right">
                                    <a href="{{ route('formulaire.champ') }}" class="btn btn-sm btn-primary">{{ __('Ajouter champ') }}</a>
                                </div>
                            </div>
                                ...
                                <table class="table">
                                    ...
                                    @foreach($formulaireTables as $formulaire)
                                        <tr>
                                            ...
                                            <td>
                                                {{ $formulaire->formulaire_id}}
                                            </td>
                                            <td>
                                                {{ $formulaire->libelle_champ }}
                                            </td>
